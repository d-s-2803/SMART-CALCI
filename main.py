...
win.configure(bg='#e4e978')

l1 = Label(win , text='I am a smart calculator',width=20 , padx=3 , bg='#cee397')
l1.place(x=180,y=10)
l2 = Label(win , text='My name is ds2803' , padx=3 , bg = '#cee397')
l2.place(x=200,y=40)
l3 = Label(win , text='How can i help you' , padx=3,bg='#cee397')
l3.place(x=196,y=100)

textin = StringVar()
e1 = Entry(win , width=30 , textvariable = textin)
e1.place(x=160,y=160)

b1 = Button(win , text='Just this' ,command=calculate,bg='#cee397')
